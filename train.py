...
class CycleGANTraining(object):
        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if(epoch % 1000 == 0 and epoch != 0):
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPoint.pth'))
                print("Model Saved!")
    ...
    def validation_for_A_dir(self):
        ...
        for file in os.listdir(validation_A_dir):
            ...
            wav_transformed = preprocess.world_speech_synthesis(f0=f0_converted,
                                                                ...
                                                                fs=sampling_rate,
                                                                frame_period=frame_period)
            soundfile.write(os.path.join(output_A_dir, os.path.basename(file)), wav_transformed, sampling_rate, subtype=None, endian=None, format=None, closefd=True)
    ...
    def validation_for_B_dir(self):
        ...
        for file in os.listdir(validation_B_dir):
            ...
            wav_transformed = preprocess.world_speech_synthesis(f0=f0_converted,
                                                                ...
                                                                fs=sampling_rate,
                                                                frame_period=frame_period)
            soundfile.write(os.path.join(output_B_dir, os.path.basename(file)), wav_transformed, sampling_rate, subtype=None, endian=None, format=None, closefd=True)
    ...
    def loadModel(self, PATH):
        ...
        return epoch, self.generator_A2B
...
if __name__ == '__main__':
    ...
    resume_training_at = './model_checkpoint/model3000.pth'
